...
# Image Posting Board - __Due Tuesday, April 12th, by 11PM__
...
* use your mongoose model for an image-post to create a new <code>ImagePost</code> instance
    ...
    * then... you can use <code>.push</code> to add each image
...
* ... and, of course, save it ([here's an example from our pizza demo](../slides/15/mongoose.html#/11))
...
* use one of these methods to add an image (assuming that you've embedded images into image-list in your schema):
	* [findOneAndUpdate](../slides/15/mongoose.html#/15)
	* [lots of callbacks](../slides/15/mongoose.html#/14)
...
* once again, get the image-post that these images belong to
    ...
    * a url param
    * ... or a hidden input
* checkbox inputs comes in as an Array or a string
...
Do one of the following for extra credit. Partial credit will be given.
...
1. Validation and Error Messages (30 points)
2. Referenced Documents (35 points)
3. Authentication (35 points)
...
* <code>/</code> ... no longer redirects to /lists, just displays links to login or register if user not logged in
...
* add a User schema; it should reference your list (see [example repository for user with images demo](https://github.com/nyu-csci-ua-0480-010-spring-2016/examples/blob/master/class16/user-image/db.js) - you'll need to be logged in to view)
* integrate passport-local-mongoose (see [bare bones authentication demo](https://github.com/nyu-csci-ua-0480-010-spring-2016/examples/tree/master/class16/passport-demo))
